...
route.get("/logs", authGuard, logController.getAllLogs);
route.get("/logs/:id", authGuard, logController.getLogById);
route.delete("/logs/:id", authGuard, logController.deleteLogById);
